        ...
        {!loading && (
          <div className="relative flex h-full">
            ...
            >
              ...
              <p
                className="text-[12px] font-medium break-words text-[#FCFDFE]"
                style={{
                  marginTop: isPast ? 8 : 4,
                  lineHeight: "20px",
                  letterSpacing: -0.12,
                }}
              >
              ...
              >
                ...
                <span className="min-w-0 truncate text-[12px] leading-[18px] font-medium text-[#FCFDFE]">
                  {ticketNumber}
                </span>
              ...
              <>
                ...
                >
                  ...
                  {state === "upcoming" && countdown && (
                    ...
                    <div
                      className="absolute flex items-center text-[#FCFDFE]"
                      style={{
